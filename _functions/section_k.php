...
function content_element_section_k($all_data, $section_index) {
    ?>
    <!-- section_k -->
    <section id="section_<?= $section_index ?>" class="a1xploretv-k px-0 a1xploretv-k-video-slider">
        ...
        <div class="a1xploretv-k-slider js-a1xploretv-k-slider">
           ...
           foreach ($all_data['videos'] as $item) {
               ...
               <?php if($item['video_provider'] == 'Vimeo'):?>
                   <a href="javascript:void(0)" data-player-id="<?= $rand; ?>" onclick="playVideoVimeo<?= $rand ?>(this);" class="js-video-global-pause a1xploretv-d-play mx-auto focusable js-a1xploretv-d-start-vimeo">
               ...
               <?php else :?>
                   <a data-id="player<?= $rand ?>" href="javascript:void(0)" onclick="playVideoYT<?= $rand ?>(this);" class="js-video-global-pause js-video-slider-btn a1xploretv-d-play mx-auto focusable js-a1xploretv-d-start">
                        <div class="video-container">
                            <div class="h1 h-bold"><?= $item['video_headline']; ?></div>
                            <h4><?= $item['video_content']; ?></h4>
                            <div class="position-relative mb-3 ">
